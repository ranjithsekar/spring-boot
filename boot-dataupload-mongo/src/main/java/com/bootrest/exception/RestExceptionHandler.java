...
public class RestExceptionHandler {
  ...
  public final ResponseEntity<Object> handleDataNotFoundException(DataNotFoundException e) {
    return buildResponseEntity(HttpStatus.NOT_FOUND.value(), new APIExceptionResponse(HttpStatus.NOT_FOUND.toString(),
        e.getMessage(), ZonedDateTime.now(ZoneId.systemDefault())));
  }
  ...
  public final ResponseEntity<Object> handleAllExceptions(Exception e) {
    return buildResponseEntity(HttpStatus.INTERNAL_SERVER_ERROR.value(), new APIExceptionResponse(
        HttpStatus.INTERNAL_SERVER_ERROR.toString(), e.getMessage(), ZonedDateTime.now(ZoneId.systemDefault())));
